    ...
    >
      ...
      <div class="card-body d-flex flex-column justify-content-between">
        ...
        <h2 class="text-white fw-bold mb-5">
          <span class="lh-lg">Active Project Indicator Bi-annual Reports</span>
        </h2>
        <!--end::Title-->
      </div>
      <!--end::Body-->
    ...
    async fetchEntities() {
      ...
      try {
        const data = await pb
          ...
          .getFullList({
            filter: `Entity != "RRF" && IndicatorPrimaryCategory='Country Results Framework' && EntityID = "${this.$route.query.entityid}" && ReportingPeriod = "Bi-Annual Report" && Year = "${this.$route.query.year}"`,
