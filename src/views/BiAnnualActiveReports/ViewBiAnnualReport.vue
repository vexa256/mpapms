    ...
    >
      ...
      <div class="card-body d-flex flex-column justify-content-between">
        ...
        <h3 class="text-white fw-bold mb-5">
          <span class="lh-lg">
            Project {{ SelectedReport }} for {{ SelectedEntity }}
...
export default {
  ...
  setup() {
    ...
    const fetchIndicators = async () => {
      try {
        const filterString = `EntityID='${route.query.entityid}' && IndicatorPrimaryCategory='Country Results Framework' && ReportingPeriod='Bi-Annual Report' && ReportingID='${route.query.reportingid}' && Year='${route.query.year}'`;
        ...
        if (existingRecord) {
          await pb
            ...
            .update(existingRecord.id, {
              ...
              AnsweredQuestion: updateForm.value.IndicatorQuestion,
