    ...
    >
      ...
      <div class="card-body d-flex flex-column justify-content-between">
        ...
        <h2 class="text-white fw-bold mb-5">
          <span class="lh-lg">Active project report years (RRF)</span>
        </h2>
        <!--end::Title-->
      </div>
      <!--end::Body-->
        ...
        <div class="card-header pt-7 mb-5">
          ...
          <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bold text-gray-800"
              >Select the project year to attach RRF reports to
            </span>
    ...
    async fetchEntities() {
      ...
      try {
        const data = await pb
          ...
          .getFullList({
            filter: `IndicatorPrimaryCategory = "Regional Results Framework" && EntityID = "${this.$route.query.entityid}"`,
          });
