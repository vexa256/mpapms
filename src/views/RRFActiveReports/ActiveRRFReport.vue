...
export default {
  ...
  setup() {
    ...
    const fetchIndicators = async () => {
      try {
        const filterString = `EntityID='${route.query.entityid}' && IndicatorPrimaryCategory = "Regional Results Framework" && ReportingID='${route.query.reportingid}' && Year='${route.query.year}'`;
