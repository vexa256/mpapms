...
export default {
  ...
  setup() {
    ...
    const fetchIndicators = async () => {
      try {
        const filterString = `EntityID='${route.query.entityid}' && IndicatorPrimaryCategory='Country Results Framework' && ReportingPeriod='Annual Report' && ReportingID='${route.query.reportingid}' && Year='${route.query.year}'`;
