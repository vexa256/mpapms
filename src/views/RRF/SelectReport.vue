      ...
      <div class="card-body pt-3 fw-bolder text-white shadow-lg table-responsive">
        <div class="alert alert-info shadow-lg">
          ...
          <div class="d-flex flex-column">
            <h4 class="mb-1 text-dark">Select RRF  Report Type To File</h4>
            <span>Select a RRF report you want to file. All reporting actions will be attached to this report.</span>
          </div>
        </div>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      async fetchReports() {
        ...
        try {
          const data = await pb.collection('mpa_rrf_active_reports')
            .getFullList();
          this.reports = data;
        } catch (error) {
