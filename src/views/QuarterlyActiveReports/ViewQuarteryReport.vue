...
export default {
  ...
  setup() {
    ...
    const fetchIndicators = async () => {
      try {
        const filterString = `EntityID='${route.query.entityid}' && ReportingPeriod='Quarterly Report' && ReportingID='${route.query.reportingid}' && Year='${route.query.year}'`;
