    ...
    >
      ...
      <div class="card-body d-flex flex-column justify-content-between">
        ...
        <h2 class="text-white fw-bold mb-5">
          <span class="lh-lg">Active Project Indicator Quarterly Reports</span>
        </h2>
        <!--end::Title-->
      </div>
      <!--end::Body-->
        ...
        <div class="card-header pt-7 mb-5">
          ...
          <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bold text-gray-800"
              >Select the specific project report to view
            </span>
            <span class="text-gray-500 mt-1 fw-semibold fs-6"
              >Only project reports with reported indicators are shown</span
            >
          </h3>
          <!--end::Title-->
                ...
                <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                  ...
                  <div class="me-5">
                    ...
                    <span
                      ...
                      >Type of report : {{ entity.Type }}</span
                    >
                    <!--end::Desc-->
                  </div>
                  <!--end::Content-->
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="m-0">
                      ...
                      <span class="badge badge-light-success fs-base">
                        <button
                          @click="selectReport(entity.ReportingID)"
...
export default {
  ...
  methods: {
    async fetchEntities() {
      ...
      try {
        const data = await pb
          .collection("mpa_active_indicator_reports_details")
          .getFullList({
            filter: `Entity != "RRF" && IndicatorPrimaryCategory='Country Results Framework' && EntityID = "${this.$route.query.entityid}" && ReportingPeriod = "Quarterly Report" && Year = "${this.$route.query.year}"`,
            sort: "ReportName", // Sorting by the 'Entity' field in alphabetical order
          });

        // Extract unique entities
        const uniqueEntities = data.reduce((acc, current) => {
          if (
            !acc.find((entity) => entity.ReportingID === current.ReportingID)
          ) {
            acc.push(current);
          }
          return acc;
